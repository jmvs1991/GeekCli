...
namespace GeekCli.Infrastructure
{
    ...
    {
        public static IServiceCollection AddGeekCliServices(this IServiceCollection services)
        {
            ...
            services.AddSingleton<IDotnetUnitTestServiceService, DotnetUnitTestServiceService>();
        ...
        public static int RunGeekCli(this IServiceCollection services, string[] args)
        {
            services.AddGeekCliServices();
